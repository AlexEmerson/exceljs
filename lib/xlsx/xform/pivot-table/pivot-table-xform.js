...
class PivotTableXform extends BaseXform {
  ...
  render(xmlStream, model) {
    ...
    // pivotTableStyleInfo
    xmlStream.writeXml(`
      <location ref="A7:E19" firstHeaderRow="1" firstDataRow="2" firstDataCol="1" rowPageCount="1" colPageCount="1" />
...
function renderPivotField(fieldType, sharedItems) {
  ...
  if (fieldType === 'row' || fieldType === 'column') {
    const axis = !fieldType ? "axisPage" : fieldType === 'row' ? 'axisRow' : 'axisCol';
    return `
